...
<h3>EnjoY TRIP GOA</h3>
<h1>UNCEASING PROVISION</h1>
<p><a class="btn btn-giant btn-primary" href="../pages/charity-donation.php" role="button">JOIN US &rarr;</a></p>
</div>
</div>
</div>
...
<p><a class="btn btn-lg btn-primary" href="../pages/ministry.php" role="button">Learn more &rarr;</a></p>
</div>
</div>
</div>
...
<p><a class="btn btn-lg btn-primary" href="../assets/image-gallery.php" role="button">Browse gallery &rarr;</a></p>
</div>
</div>
</div>
</div>
...
<a class="btn btn-lg btn-primary" href="../pages/event-single.php" role="button">Program details →</a> </div>
</div>


<div class="container">
<div class="row feature-block">
<div class="col-md-4 col-sm-6 has-margin-bottom"> <img class="img-responsive" src="<?= $baseurl ?>/assets/images/thumb-1.jpg" alt="catholic church">
...
<p><a href="../pages/about.php" role="button">View details →</a></p>
</div>

<div class="col-md-4 col-sm-6 has-margin-bottom"> <img class="img-responsive" src="<?= $baseurl ?>/assets/images/thumb-2.jpg" alt="ministry sermon">
...
<p><a href="../pages/sermons.php" role="button">View details →</a></p>
</div>

<div class="col-md-4 col-sm-8 col-sm-offset-2 col-md-offset-0 center-this has-margin-bottom"> <img class="img-responsive" src="<?= $baseurl ?>/assets/images/thumb-3.jpg" alt="bulletin programs">
...
<p><a href="../pages/events-programs.php" role="button">View details →</a></p>
</div>
...
<p class="el-cta"><a class="btn btn-primary" href="../pages/event-single.php" role="button">Details &rarr;</a></p>
</div>
<div class="el-block item">
<h4> JUL 29 </h4>
...
<div class="col-md-4 col-sm-4"> <img class="img-responsive center-block" src="<?= $baseurl ?>/assets/images/blog-thumb-1.jpg" alt="bulletin blog"> </div>
...
<a class="btn btn-primary" href="../pages/blog-single.php" role="button">Read Article →</a> </div>
</div>

<div class="row">
<div class="col-md-4 col-sm-4"> <img class="img-responsive center-block" src="<?= $baseurl ?>/assets/images/blog-thumb-2.jpg" alt="bulletin blog"> </div>
<div class="col-md-8 col-sm-8 bulletin">
...
<a href="#"><img src="<?= $baseurl ?>/assets/images/video-thumb.jpg" class="img-responsive center-block" alt="video thumb"></a>
<div class="list-group"> <a href="../pages/sermons.php" class="list-group-item">
...
<div class="charity-../assets/image"> <img src="<?= $baseurl ?>/assets/images/charity-donation.jpg" class="img-responsive" alt="charity donation fundraising"></div>
...
<div class="donate-now"> <a href="../pages/charity-donation.php" class="btn btn-lg btn-primary">Donate Now →</a> </div>
</div>
</div>
</div>
...
<div class="col-sm-4 col-md-3"> <a class="fancybox" href="<?= $baseurl ?>/assets/images/gallery/img_gallery_1.jpg" data-fancybox-group="gallery" title="church ../assets/image gallery"> <img src="<?= $baseurl ?>/assets/images/gallery/thumb/gallery_thumb_1.jpg" class="img-responsive" width="270" height="270" alt="church ../assets/image gallery"> </a> </div>
<div class="col-sm-4 col-md-3"> <a class="fancybox" href="<?= $baseurl ?>/assets/images/gallery/img_gallery_2.jpg" data-fancybox-group="gallery" title="church ../assets/image gallery"> <img src="<?= $baseurl ?>/assets/images/gallery/thumb/gallery_thumb_2.jpg" class="img-responsive" width="270" height="270" alt="church ../assets/image gallery"> </a> </div>
<div class="col-sm-4 col-md-3"> <a class="fancybox" href="<?= $baseurl ?>/assets/images/gallery/img_gallery_3.jpg" data-fancybox-group="gallery" title="church ../assets/image gallery"> <img src="<?= $baseurl ?>/assets/images/gallery/thumb/gallery_thumb_3.jpg" class="img-responsive" width="270" height="270" alt="church ../assets/image gallery"> </a> </div>
<div class="col-sm-4 col-md-3"> <a class="fancybox" href="<?= $baseurl ?>/assets/images/gallery/img_gallery_4.jpg" data-fancybox-group="gallery" title="church ../assets/image gallery"> <img src="<?= $baseurl ?>/assets/images/gallery/thumb/gallery_thumb_4.jpg" class="img-responsive" width="270" height="270" alt="church ../assets/image gallery"> </a> </div>
<div class="col-sm-4 col-md-3"> <a class="fancybox" href="<?= $baseurl ?>/assets/images/gallery/img_gallery_5.jpg" data-fancybox-group="gallery" title="church ../assets/image gallery"> <img src="<?= $baseurl ?>/assets/images/gallery/thumb/gallery_thumb_5.jpg" class="img-responsive" width="270" height="270" alt="church ../assets/image gallery"> </a> </div>
<div class="col-sm-4 col-md-3"> <a class="fancybox" href="<?= $baseurl ?>/assets/images/gallery/img_gallery_6.jpg" data-fancybox-group="gallery" title="church ../assets/image gallery"> <img src="<?= $baseurl ?>/assets/images/gallery/thumb/gallery_thumb_6.jpg" class="img-responsive" width="270" height="270" alt="church ../assets/image gallery"> </a> </div>
<div class="col-sm-4 col-md-3"> <a class="fancybox" href="<?= $baseurl ?>/assets/images/gallery/img_gallery_7.jpg" data-fancybox-group="gallery" title="church ../assets/image gallery"> <img src="<?= $baseurl ?>/assets/images/gallery/thumb/gallery_thumb_7.jpg" class="img-responsive" width="270" height="270" alt="church ../assets/image gallery"> </a> </div>
<div class="col-sm-4 col-md-3"> <a class="fancybox" href="<?= $baseurl ?>/assets/images/gallery/img_gallery_8.jpg" data-fancybox-group="gallery" title="church ../assets/image gallery"> <img src="<?= $baseurl ?>/assets/images/gallery/thumb/gallery_thumb_8.jpg" class="img-responsive" width="270" height="270" alt="church ../assets/image gallery"> </a> </div>
</div>
</div>
...
<div class="row feature-block">
<div class="col-md-4 col-sm-6 has-margin-bottom"> <img class="img-responsive" src="<?= $baseurl ?>/assets/images/ministry_1.jpg" alt="catholic church">
...
<p><a href="../pages/ministry.php" role="button">Read more →</a></p>
</div>

<div class="col-md-4 col-sm-6 has-margin-bottom"> <img class="img-responsive" src="<?= $baseurl ?>/assets/images/ministry_2.jpg" alt="ministry sermon">
...
<div class="col-md-4 col-sm-8 col-sm-offset-2 col-md-offset-0 center-this has-margin-bottom"> <img class="img-responsive" src="<?= $baseurl ?>/assets/images/ministry_3.jpg" alt="bulletin programs">
